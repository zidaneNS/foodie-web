  ...
  return (
    ...
    >
      {Array.from({ length: 4 }).map((_, idx) => (
        <div key={idx}>
          <div className="p-4 md:p-8 bg-black flex gap-x-8 md:gap-x-64 items-center text-white justify-center">
            <div className="flex flex-col gap-y-3 md:gap-y-6 max-w-1/2 md:max-w-1/3">
